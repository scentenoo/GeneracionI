...
class PlaneacionScreen(ctk.CTkScrollableFrame):
    ...
    def _construir_columnas_clase(self):
        ctk.CTkLabel(
            self, text="Sobre toda la clase", font=tema.fuente(peso="bold")
    ...
    def _construir_asistencia(self):
        ctk.CTkLabel(self, text="Asistencia", anchor="w", font=tema.fuente(peso="bold")).pack(
            fill="x", pady=(16, 4)
        )
    ...
    def _construir_acciones(self):
        ...
        ctk.CTkLabel(
            self, text="Revise la vista previa para poder guardar.",
            text_color=tema.GRIS, font=tema.fuente(11),
        ).pack()
